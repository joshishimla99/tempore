...
/**
 * Generic abstract {@link GwtRpcDataSource} implementation, based on the
 * {@link GwtRpcDataSource} example provided in the smartgwt-extensions. Extend this
 * class if you want to create a GwtRpcDataSource for SmartGWT.
 * 
 * In order to use this class, you have to implement both
 * {@link GenericGwtRpcDataSourceService} and {@link GenericGwtRpcDataSourceServiceAsync}
 ...
 *            {@link GenericGwtRpcDataSourceService} and then 
 *            {@link GenericGwtRpcDataSourceServiceAsync} to implement it.
 * 
 * @see GwtRpcDataSource
 * @see GenericGwtRpcDataSourceService
 * @see GenericGwtRpcDataSourceServiceAsync
 * 
 ...
 * @version 1.0
 */
public abstract class GenericGwtRpcDataSource<D, R extends Record, SA extends GenericGwtRpcDataSourceServiceAsync<D>>
	...
	/**
	 * @return the {@link GenericGwtRpcDataSourceServiceAsync} to use, created
	 *         using
	...
	protected void executeFetch(final String requestId, final DSRequest request, final DSResponse response) {
		...
		// request.getEndRow ();
		// request.getSortBy ();
		getServiceAsync().fetch(new AsyncCallback<List<D>>() {
