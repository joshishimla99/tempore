function tempore(){
  ...
  $stats && $stats({moduleName:'tempore', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'begin'});
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      var iframe = $doc_0.getElementById('tempore');
      ...
      tempore = null;
      frameWnd.gwtOnLoad(onLoadErrorFunc, 'tempore', base, softPermutationId);
      $stats && $stats({moduleName:'tempore', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'end'});
    }
  }
  ...
  function computeScriptBase(){
    ...
    function tryNocacheJsTag(){
      ...
      for (var i = 0; i < scriptTags.length; ++i) {
        if (scriptTags[i].src.indexOf('tempore.nocache.js') != -1) {
    ...
    function tryMarkerScript(){
      ...
      if (typeof isBodyLoaded == 'undefined' || !isBodyLoaded()) {
        var markerId = '__gwt_marker_tempore';
        var markerScript;
  ...
  function maybeInjectFrame(){
    if (!frameInjected) {
      ...
      $stats && $stats({moduleName:'tempore', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'moduleRequested'});
  ...
  ;
  tempore.onInjectionDone = function(){
    scriptsDone = true;
    $stats && $stats({moduleName:'tempore', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'end'});
    maybeStartModule();
  }
  ;
  processMetas();
  ...
  var initialHtml;
  if (isHostedMode()) {
    if ($wnd_0.external && ($wnd_0.external.initModule && $wnd_0.external.initModule('tempore'))) {
      $wnd_0.location.reload();
      return;
    }
    initialHtml = 'hosted.html?tempore';
    strongName = '';
  }
  $stats && $stats({moduleName:'tempore', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'selectingPermutation'});
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['ie9'], '649D98B05E1598CC90C349A9DFE75DAB');
      unflattenKeylistIntoAnswers(['opera'], '6A0431CD524035068C99DD3CA8FD17D1');
      unflattenKeylistIntoAnswers(['gecko1_8'], 'A431E551574DC9C09E8345F09DE901B6');
      unflattenKeylistIntoAnswers(['ie6'], 'BACD18096E7CA7E5D8447C8B6DD8D980');
      unflattenKeylistIntoAnswers(['safari'], 'D4953612A0DEB79B13786A0885D54DDC');
      unflattenKeylistIntoAnswers(['ie8'], 'FA3DCAA915B10AEA6ACCB9590356C81B');
  ...
  , 50);
  $stats && $stats({moduleName:'tempore', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'end'});
  $stats && $stats({moduleName:'tempore', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'begin'});
  ...
  $doc_0.write('<script defer="defer">tempore.onInjectionDone(\'tempore\')<\/script>');
}
